...
Durante o projeto, foram explorados conceitos fundamentais de análise de dados utilizando DataFrames e Series, incluindo importação de dados, filtragem, ordenação, tratamento de valores nulos e conversão de tipos de dados.
...
* Filtros e comparações booleanas
* Análise exploratória com `info()` e `describe()`
* Ordenação de dados com `sort_values()`
* Conversão de tipos utilizando `to_numeric()` e `astype()`
